...
"""
  filter source code files with pb2.py ends
  and import this files and get object
"""
...
# return the dynamic object by object type name
# equals to know "x" lambda (x):import x:return x()
